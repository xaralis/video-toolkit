...
|-------|------|--------|---------|
| `remotion-official` | `skills/remotion-official/` | [remotion-dev/skills](https://github.com/remotion-dev/skills) | Core framework knowledge (hooks, animations, rendering, media, etc.) |
| `remotion` | `skills/remotion/` | This toolkit | Custom transitions, shared components, project conventions |
...
2. Compares `skills/remotion-best-practices/` against our `skills/remotion-official/`
...
# Copy into toolkit
rm -rf skills/remotion-official
cp -r /tmp/remotion-skills/skills/remotion-best-practices skills/remotion-official

# Commit
git add skills/remotion-official
